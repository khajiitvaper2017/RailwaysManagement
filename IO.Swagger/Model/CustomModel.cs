...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CustomModel :  IEquatable<CustomModel>, IValidatableObject
    {
        /// <summary>
        ...
        public CustomModel(List<Object> speed = default(List<Object>), List<Object> priority = default(List<Object>), decimal? distanceInfluence = 70, FeatureCollection areas = default(FeatureCollection))
        {
            Speed = speed;
            Priority = priority;
        ...
        public FeatureCollection Areas { get; set; }
        ...
        {
            return Equals(input as CustomModel);
        }

        /// <summary>
        /// Returns true if CustomModel instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomModel input)
        {
            if (input == null)
                return false;
