...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfRouteResponsePathPoints :  IEquatable<AllOfRouteResponsePathPoints>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfRouteResponsePathPoints" /> class.
        /// </summary>
        public AllOfRouteResponsePathPoints()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfRouteResponsePathPoints {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return Equals(input as AllOfRouteResponsePathPoints);
        }

        /// <summary>
        /// Returns true if AllOfRouteResponsePathPoints instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfRouteResponsePathPoints to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfRouteResponsePathPoints input)
        {
            if (input == null)
                return false;
