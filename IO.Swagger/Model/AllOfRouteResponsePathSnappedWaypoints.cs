...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfRouteResponsePathSnappedWaypoints :  IEquatable<AllOfRouteResponsePathSnappedWaypoints>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfRouteResponsePathSnappedWaypoints" /> class.
        /// </summary>
        public AllOfRouteResponsePathSnappedWaypoints()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfRouteResponsePathSnappedWaypoints {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return Equals(input as AllOfRouteResponsePathSnappedWaypoints);
        }

        /// <summary>
        /// Returns true if AllOfRouteResponsePathSnappedWaypoints instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfRouteResponsePathSnappedWaypoints to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfRouteResponsePathSnappedWaypoints input)
        {
            if (input == null)
                return false;
