...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class FeatureCollectionFeatures :  IEquatable<FeatureCollectionFeatures>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FeatureCollectionFeatures" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="geometry">geometry.</param>
        public FeatureCollectionFeatures(TypeEnum? type = default(TypeEnum?), Polygon geometry = default(Polygon))
        {
            Type = type;
            Geometry = geometry;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FeatureCollectionFeatures {\n");
        ...
        {
            return Equals(input as FeatureCollectionFeatures);
        }

        /// <summary>
        /// Returns true if FeatureCollectionFeatures instances are equal
        /// </summary>
        /// <param name="input">Instance of FeatureCollectionFeatures to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FeatureCollectionFeatures input)
        {
            if (input == null)
                return false;
