...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Polygon :  IEquatable<Polygon>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        public Polygon(TypeEnum? type = default(TypeEnum?), List<List<List<decimal?>>> coordinates = default(List<List<List<decimal?>>>))
        {
            Type = type;
        ...
        {
            return Equals(input as Polygon);
        }

        /// <summary>
        /// Returns true if Polygon instances are equal
        /// </summary>
        /// <param name="input">Instance of Polygon to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Polygon input)
        {
            if (input == null)
                return false;
